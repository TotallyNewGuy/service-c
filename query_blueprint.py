...
async def most_recent_trips():
    ...
    timepointid = request.args.get('timepointid', default = None, type = str)
    runid = request.args.get('runid', default = None, type = str)
    ...
    res = await get_or_cache(curr_time=curr_time, prev=prev, future=future, timepointid=timepointid, runid=runid)
    return res, 200